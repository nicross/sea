content.audio.surface.smack = (() => {
  ...
  function trigger({
    ...
    const isTurbo = content.movement.isTurbo()
...
engine.ready(() => {
  content.movement.on('surface-smack', (e) => content.audio.surface.smack.trigger(e))
  content.movement.on('transition-surface', () => content.audio.surface.smack.surface())
  content.movement.on('transition-underwater', () => content.audio.surface.smack.underwater())
})

engine.state.on('import', () => content.audio.surface.smack.import())
