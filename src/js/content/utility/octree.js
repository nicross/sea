...
content.utility.octree = {}

content.utility.octree.create = function (...args) {
  return Object.create(this.prototype).construct(...args)
}

content.utility.octree.from = function (items = [], options = {}) {
...
content.utility.octree.prototype = {
  clear: function () {
    this.items.length = 0
    this.nodes.length = 0
    return this
  ...
  construct: function ({
    depth = engine.const.maxSafeFloat * 2,
  ...
  split: function () {
    ...
    this.nodes[0] = content.utility.octree.create({
      depth,
      height,
    ...
    this.nodes[1] = content.utility.octree.create({
      depth,
      height,
      maxItems: this.maxItems,
      width,
    ...
    this.nodes[2] = content.utility.octree.create({
      depth,
      height,
      maxItems: this.maxItems,
      width,
    ...
    this.nodes[3] = content.utility.octree.create({
      depth,
      height,
      maxItems: this.maxItems,
      width,
    ...
    this.nodes[4] = content.utility.octree.create({
      depth,
      height,
      maxItems: this.maxItems,
      width,
    ...
    this.nodes[5] = content.utility.octree.create({
      depth,
      height,
      maxItems: this.maxItems,
      width,
    ...
    this.nodes[6] = content.utility.octree.create({
      depth,
      height,
      maxItems: this.maxItems,
      width,
    ...
    this.nodes[7] = content.utility.octree.create({
      depth,
      height,
      maxItems: this.maxItems,
      width,
