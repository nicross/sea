...
engine.loop.on('frame', ({paused}) => {
  ...
  const {angle, rotation, velocity} = content.system.engineMovement.get()
...
engine.state.on('reset', () => content.system.engineMovement.reset())
